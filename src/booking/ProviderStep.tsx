      ...
      <div className="mt-6 grid gap-4 sm:grid-cols-3">
        {barbers.map((provider) => (
          <button
            ...
            className="group flex flex-col items-center gap-3 rounded-3xl border border-white/10 bg-charcoal p-7 text-center transition-all hover:-translate-y-1 hover:border-gold/50"
          >
